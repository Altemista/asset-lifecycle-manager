...
import (
	...
	"github.com/Altemista/asset-lifecycle-manager/pkg/controller"
...
func main() {
	...
	err = leader.Become(ctx, "aalm-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	// Setup Scheme for olm resources
	if err = olmv1.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}

	// Setup Scheme for alpha olm resources
